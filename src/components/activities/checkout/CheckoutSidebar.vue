  ...
  <div class="sticky-sidebar">
    ...
    >
      ...
      <v-card-text>
        ...
        <div class="g2a-text-16 g2a-text-bold-600 mb-4">
          Booking Summary
        </div>
        ...
        <div class="summary-row">
          ...
          <strong>
            ₹{{ booking.product?.starting_price || 0 }}
          </strong>
        </div>
        ...
        >
          <div class="g2a-text-16 g2a-text-bold-700">
            Total
          </div>

          <div
            class="g2a-title text-brandColor2"
          >
            ₹{{ total }}
          </div>
        </div>
...
const slotName = computed(() => {
  if (!booking.form.slot)
    return "-";

  const slot =
    booking.product?.slots?.find(
      (x) =>
        x.id ===
        booking.form.slot
    );
